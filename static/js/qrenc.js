//Using jsqrencode from https://code.google.com/archive/p/jsqrencode/
var QREnc = function (config) {
	// alignment pattern
	var adelta = [
	...
	function doqr() {
		...
		qrd = document.getElementById(config.qrdiv);
		...
		var elem = document.getElementById(config.qrcanv);
